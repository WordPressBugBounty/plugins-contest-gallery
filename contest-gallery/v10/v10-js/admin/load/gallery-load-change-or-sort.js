cgJsClassAdmin.gallery.load.changeViewByControl = function ($,$cgStep,$cgStart,isFormSubmit,isInput,isRealFormSubmit,$selected,isFromSortingFiles) {
        ...
        var $cgGallerySubmitTop = $('#cgGallerySubmitTop');
        ...
        $('#cgGallerySubmitTop').addClass('cg_hide');// do not remove
        ...
        cgJsClassAdmin.gallery.functions.requests.push($.ajax({
            ...
            $cgGallerySubmitTop.get(0).replaceWith(DOM_cgGallerySubmitTop);
            $cgSortable = $(DOM_cgSortable);
            $cgGallerySubmitTop = $(DOM_cgGallerySubmitTop);
            cgJsClassAdmin.gallery.vars.$cgGallerySubmitTop = $cgGallerySubmitTop;
            cgJsClassAdmin.gallery.vars.$cgSortable = $cgSortable;
            ...
            if($(DOM_cgSortable).find('.cg_sortable_div').length>=1){
