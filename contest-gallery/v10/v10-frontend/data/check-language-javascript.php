<?php
// Compatibility shim for order-summary renderers that still expect the legacy inline language bootstrap.
?>
<pre>
<script data-cg-processing="true">
	...
	cgJsClass.gallery.language[index].SlowDownComment = <?php echo json_encode($language_SlowDownComment); ?>;
