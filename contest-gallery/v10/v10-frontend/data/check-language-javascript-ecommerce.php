<?php
// Compatibility shim for order-summary renderers that still expect the legacy inline ecommerce-language bootstrap.
?>
<script data-cg-processing="true">
	...
	if (typeof cgJsClass.gallery.vars.isWereSetEcommerceLanguage == 'undefined') {
