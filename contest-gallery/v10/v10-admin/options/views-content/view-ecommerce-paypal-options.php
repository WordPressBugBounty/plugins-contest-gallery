				    ...
				    <div class='cg_border_radius_unset  cg_border_top_none cg_view_option cg_border_bottom_none cg_view_option_100_percent cg_border_right_none' id="PayPalTestActiveOption">
				        <div class='cg_view_option_title' style="width: 75%;">
				            <p>Enable PayPal Sandbox Testing<br>
				                <span class="cg_view_option_title_note"><b>NOTE:</b> <span class="cg_note_text">Disable this option after testing is finished. Otherwise not desired test purchases might happen if somebody knows the logic and use official credit card numbers for testing from PayPal.</span></span>
				            </p>
				        </div>
				        <div class='cg_view_option_checkbox'>
