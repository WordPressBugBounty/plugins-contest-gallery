...
<a class=" cg_no_outline_and_shadow_on_focus" href="{$editTranslationLink}l_AllVotesUsed"  target="_blank">translation</a> will be shown</span></p>
                    </div>
...
echo <<<HEREDOC
            <div class='cg_view_options_row'>
               <div class='cg_view_option cg_view_option_100_percent' id="ThankVoteContainer" >
                    <div class='cg_view_option_title'>
                        <p>Show thank you for voting message after voting<br/><span class="cg_view_option_title_note">After vote is done thank you for voting message appears.<br>Translation for the message can be found  <a class="cg_no_outline_and_shadow_on_focus" href="{$editTranslationLink}l_ThankVote"  target="_blank">here</a></span></span></p>
                    </div>
                    <div class='cg_view_option_checkbox'>
...
echo <<<HEREDOC
            <div class='cg_view_options_row'>
                <div class='cg_view_option cg_view_option_50_percent cg_border_top_right_none $cgProFalse' id="ShowOnlyUsersVotesContainer" >
                    <div class='cg_view_option_title'>
                        <p>Show only user votes<br/>(for cg_gallery, cg_gallery_user and cg_gallery_ecommerce shortcodes)<br/><span class="cg_view_option_title_note">User see only his votes not the whole rating</span></p>
                    </div>
                    <div class='cg_view_option_checkbox'>
               ...
               <div class='cg_view_option cg_view_option_50_percent cg_border_top_none $cgProFalse' id="HideUntilVoteContainer" >
                    <div class='cg_view_option_title'>
                        <p>Hide rating of an entry<br/>until user voted for this entry<br/>(for cg_gallery, cg_gallery_user and cg_gallery_ecommerce shortcodes)<br/><span class="cg_view_option_title_note">Sort by rating and preselect by rating<br>on page load is not possible then</span></p>
                    </div>
                    <div class='cg_view_option_checkbox'>
