    ...
    <div class='cg_view_options_rows_container'>
        ...
        <div class='cg_view_options_row'>
            <div class='cg_view_option cg_border_radius_8_px cg_view_option_100_percent $cgProFalse' id="ContestEndInstantContainer">
                <div class='cg_view_option_title'>
                    <p>Review comments<br><span class="cg_view_option_title_note">Comments does not appear immediately after commenting.<br>"Your comment will be reviewed" <a class="cg_no_outline_and_shadow_on_focus" href="{$editTranslationLink}YourCommentWillBeReviewedRow"  data-cg-go-to-link="YourCommentWillBeReviewedRow"   target="_blank">translation</a> is visible instead.<br> Comments can be then manually activated in backend images area and then getting visibile in frontend.</span></p>
                </div>
                <div class='cg_view_option_checkbox'>
