...
<div class='cg_view_options_rows_container'>
         <p class='cg_view_options_rows_container_title'>Upload/Registration/Comment form</p>
HEREDOC;
echo <<<HEREDOC
...
echo <<<HEREDOC
         ...
         <div class='cg_view_options_row'>
                <div class='cg_view_option cg_view_option_full_width cg_border_top_none' >
                    <div class='cg_view_option_title'>
                        <p>$language_Send<br><span style="font-weight:normal;">(Submit button text for upload/registration/comment form)</span>$cgShortcodeCopy</p>
                    </div>
                    <div class='cg_view_option_input'>
