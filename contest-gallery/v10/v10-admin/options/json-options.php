...
$jsonOptions['visual']['VotingCommentNumberFormat'] = (!empty($VotingCommentNumberFormat) && $VotingCommentNumberFormat === 'comma') ? 'comma' : 'dot';
...
$jsonOptions['general']['AllowRatingAverage'] = $AllowRatingAverage;
...
$jsonOptions['pro']['ShowRefreshButtonAfterUpload'] = $ShowRefreshButtonAfterUpload;
...
$jsonOptions['general']['AllowRatingForGalleryEcommerce'] = $AllowRatingForGalleryEcommerce;
...
$jsonOptions['pro']['ConsentYoutube'] = $ConsentYoutube;
$jsonOptions['pro']['ConsentTwitter'] = $ConsentTwitter;
