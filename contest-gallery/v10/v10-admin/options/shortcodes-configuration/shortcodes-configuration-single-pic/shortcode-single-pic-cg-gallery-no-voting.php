...
if($jsonOptions[$GalleryID.'-nv']['visual']['ShareButtons'] === '0' || $jsonOptions[$GalleryID.'-nv']['visual']['ShareButtons'] === 0){
    $jsonOptions[$GalleryID.'-nv']['visual']['ShareButtons'] = '';
}
...
if(floatval($galleryDbVersion)>=21){
    ...
    if(!isset($jsonOptions[$GalleryID.'-nv']['pro']['BackToGalleryButtonURL'])){
        $jsonOptions[$GalleryID.'-nv']['pro']['BackToGalleryButtonURL'] = '';
    }else{
