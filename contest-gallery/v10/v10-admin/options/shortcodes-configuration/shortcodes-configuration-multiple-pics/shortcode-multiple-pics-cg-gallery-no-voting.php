...
cg1l_correct_view_options_and_order($order,$jsonOptions[$GalleryID.'-nv']['general']['ThumbLook'],$jsonOptions[$GalleryID.'-nv']['general']['SliderLook'],$jsonOptions[$GalleryID.'-nv']['visual']['BlogLook'],$jsonOptions[$GalleryID.'-nv']['general']['HeightLook'],$jsonOptions[$GalleryID.'-nv']['general']['RowLook'], true);
        ...
        <div class='cg_view_option_radio_multiple'>
            <div class='cg_view_option_radio_multiple_container ThumbLookContainer cg_one_third_width'>
                ...
                <div class='cg_view_option_radio_multiple_input'>
                    <input type="radio" name="multiple-pics[cg_gallery_no_voting][general][ThumbLook]" class="OrderLook cg_view_option_radio_multiple_input_field" checked="{$jsonOptions[$GalleryID.'-nv']['general']['ThumbLook']}">
                </div>
            </div>
            <div class='cg_view_option_radio_multiple_container SliderLookContainer cg_one_third_width'>
                ...
                <div class='cg_view_option_radio_multiple_input'>
                    <input type="radio" name="multiple-pics[cg_gallery_no_voting][general][SliderLook]" class="OrderLook cg_view_option_radio_multiple_input_field" checked="{$jsonOptions[$GalleryID.'-nv']['general']['SliderLook']}">
                </div>
            </div>
            <div class='cg_view_option_radio_multiple_container BlogLookContainer cg_one_third_width'>
                ...
                <div class='cg_view_option_radio_multiple_input'>
                    <input type="radio" name="multiple-pics[cg_gallery_no_voting][visual][BlogLook]" class="OrderLook cg_view_option_radio_multiple_input_field" checked="{$jsonOptions[$GalleryID.'-nv']['visual']['BlogLook']}">
                </div>
            </div>
        </div>
    </div>
...
<div class='cg_view_options_row'>
    <div class='cg_view_option cg_border_top_none cg_border_right_bottom_none '>
        <div class='cg_view_option_title'>
    ...
    <div  class='cg_view_option cg_border_top_none cg_border_bottom_none  AllowSortContainer'>
        <div class='cg_view_option_title'>
        <p>Allow sort</p>
        </div>
        <div  class='cg_view_option_checkbox'>
...
<div class='cg_view_options_row'>
    ...
    <div class='cg_view_option cg_view_option_flex_flow_column cg_border_top_none PreselectSortContainer'>
        ...
        <select name='multiple-pics[cg_gallery_no_voting][pro][PreselectSort]' class='PreselectSort cg_no_outline_and_shadow_on_focus'>
HEREDOC;
...
$PreselectSort_rating_desc_average_selected = ($jsonOptions[$GalleryID.'-nv']['pro']['PreselectSort']=='rating_desc_average') ? 'selected' : '';
$PreselectSort_rating_asc_average_selected = ($jsonOptions[$GalleryID.'-nv']['pro']['PreselectSort']=='rating_asc_average') ? 'selected' : '';
...
echo <<<HEREDOC
        ...
        <option value='rating_desc_average' class='$cgGalleryNoVotingRatingHidden $cgGalleryNoVotingRatingInputs' $PreselectSort_rating_desc_average_selected>Rating average descending (for average rating)</option>
        <option value='rating_asc_average' class='$cgGalleryNoVotingRatingHidden $cgGalleryNoVotingRatingInputs' $PreselectSort_rating_asc_average_selected>Rating average ascending (for average rating)</option>
...
if(isset($jsonOptions[$GalleryID.'-nv']['visual']['ShowDate'])){
	$ShowDate = absint($jsonOptions[$GalleryID.'-nv']['visual']['ShowDate']);
	if(!in_array($ShowDate,array(0,1,2,3),true)){
		$ShowDate = !empty($jsonOptions[$GalleryID.'-nv']['visual']['ShowDate']) ? 1 : 0;
	}
}else{
	$ShowDate = 0;
}
        ...
        <div class="cg_view_options_row">
                <div class="cg_view_option cg_view_option_50_percent cg_border_top_none cg_border_right_none cg_border_bottom_none ShowDateContainer" >
                    ...
                    <div class="cg_view_option_checkbox $ShowDateCheckboxClass">
                        <input type="checkbox" name="multiple-pics[cg_gallery_no_voting][visual][ShowDate]" class="cg_shortcode_checkbox ShowDate" $ShowDateChecked>
                    </div>
                </div>
HEREDOC;
...
echo <<<HEREDOC
    <div  class='cg_view_option cg_border_top_none cg_border_left_none cg_border_bottom_none cg_view_option_50_percent cg_view_option_flex_flow_column ShowDateFormatContainer $ShowDateDisabledClass'>
        ...
        <div class="cg_view_option_select">
        <select name="multiple-pics[cg_gallery_no_voting][visual][ShowDateFormat]" class="cg_no_outline_and_shadow_on_focus">
HEREDOC;

// only json option, not in database available
if(!empty($jsonOptions[$GalleryID.'-nv']['visual']['ShowDateFormat'])){
	$ShowDateFormat = $jsonOptions[$GalleryID.'-nv']['visual']['ShowDateFormat'];
}else{
    ...
    <div class='cg_view_option cg_view_option_full_width cg_border_top_none ShowDateViewContainer $ShowDateDisabledClass'>
        <div class='cg_view_option_radio_multiple'>
            <div class='cg_view_option_radio_multiple_container cg_border_top_none'>
                ...
                <div class='cg_view_option_radio_multiple_input'>
                    <input type="radio" name="multiple-pics[cg_gallery_no_voting][visual][ShowDateView]" class="cg_view_option_radio_multiple_input_field" $ShowDateView1 value="1" />
                </div>
            </div>
            <div class='cg_view_option_radio_multiple_container cg_border_top_none'>
                <div class='cg_view_option_radio_multiple_title'>
                ...
                <div class='cg_view_option_radio_multiple_input'>
                    <input type="radio" name="multiple-pics[cg_gallery_no_voting][visual][ShowDateView]" class="cg_view_option_radio_multiple_input_field" $ShowDateView2 value="2" />
                </div>
            </div>
            <div class='cg_view_option_radio_multiple_container cg_border_top_none'>
                <div class='cg_view_option_radio_multiple_title'>
                ...
                <div class='cg_view_option_radio_multiple_input'>
                    <input type="radio" name="multiple-pics[cg_gallery_no_voting][visual][ShowDateView]" class="cg_view_option_radio_multiple_input_field" $ShowDateView3 value="3" />
                </div>
            </div>
        </div>
    </div>
...
} elseif(!isset($jsonOptions[$GalleryID.'-nv']['general']['ShowAlways']) && $ShowAlways != 'checked') {
...
} elseif(!isset($jsonOptions[$GalleryID.'-nv']['general']['RegUserGalleryOnly']) && $RegUserGalleryOnly != 'checked') {
...
if(!isset($jsonOptions[$GalleryID.'-nv']['pro']['RegUserGalleryOnlyText'])){
    ...
    $jsonOptions[$GalleryID.'-nv']['pro']['RegUserGalleryOnlyText'] = contest_gal1ery_convert_for_html_output_without_nl2br($jsonOptions[$GalleryID.'-nv']['pro']['RegUserGalleryOnlyText']);
}
...
HEREDOC;
    ...
    // only json option, not in database available
    if(!isset($jsonOptions[$GalleryID.'-nv']['visual']['HeaderWpPageParent'])){
        $HeaderWpPageParent = "";
    }else{
        $HeaderWpPageParent = contest_gal1ery_convert_for_html_output_without_nl2br($jsonOptions[$GalleryID.'-nv']['visual']['HeaderWpPageParent']);
    }
    ...
    <div class='cg_view_options_row'>
        <div class='cg_view_option cg_view_option_full_width  cg_border_top_none '>
            ...
            <div class='cg_view_option_textarea' >
                <textarea type="text" name="multiple-pics[cg_gallery_no_voting][visual][HeaderWpPageParent]" rows="7" style="width:100%;" class="HeaderWpPageParent"  >$HeaderWpPageParent</textarea>
            </div>
        </div>
    </div>
HEREDOC;
    ...
    // only json option, not in database available
    if(!isset($jsonOptions[$GalleryID.'-nv']['visual']['TextBeforeWpPageParent'])){
        $TextBeforeWpPageParent = "";
    }else{
        $TextBeforeWpPageParent = contest_gal1ery_convert_for_html_output_without_nl2br($jsonOptions[$GalleryID.'-nv']['visual']['TextBeforeWpPageParent']);
    }

    echo <<<HEREDOC
<div class='cg_view_options_row'>
    <div class='cg_view_option cg_view_option_full_width cg_border_top_none' id="wp-TextBeforeWpPageParentNoVoting-wrap-Container">
        <div class='cg_view_option_title'>
        ...
        <div class='cg_view_option_html'>
            <textarea class='cg-wp-editor-template' name='multiple-pics[cg_gallery_no_voting][visual][TextBeforeWpPageParent]'  id='TextBeforeWpPageParentNoVoting'>$TextBeforeWpPageParent</textarea>
        </div>
    </div>
</div>
HEREDOC;
    ...
    // only json option, not in database available
    if(!isset($jsonOptions[$GalleryID.'-nv']['visual']['TextAfterWpPageParent'])){
        $TextAfterWpPageParent = "";
    }else{
        $TextAfterWpPageParent = contest_gal1ery_convert_for_html_output_without_nl2br($jsonOptions[$GalleryID.'-nv']['visual']['TextAfterWpPageParent']);
    }

    echo <<<HEREDOC
<div class='cg_view_options_row'>
    <div class='cg_view_option cg_view_option_full_width cg_border_top_none' id="wp-TextAfterWpPageParentNoVoting-wrap-Container">
        <div class='cg_view_option_title'>
        ...
        <div class='cg_view_option_html'>
            <textarea class='cg-wp-editor-template' name='multiple-pics[cg_gallery_no_voting][visual][TextAfterWpPageParent]'  id='TextAfterWpPageParentNoVoting'>$TextAfterWpPageParent</textarea>
        </div>
    </div>
</div>
HEREDOC;
                    ...
                    <div class='cg_view_option cg_view_options_and_order_checkbox_container cg_view_option_100_percent BlogLookContainer cg_border_radius_8_px'>
                        <div class='cg_view_option_title'>
                         ...
                         <div  class='cg_view_option_radio'>
                            <input type="radio" name="multiple-pics[cg_gallery_no_voting][visual][BlogLook]" class="OrderLook" checked="{$jsonOptions[$GalleryID.'-nv']['visual']['BlogLook']}">
                         </div>
                    </div>
                </div>
            </div>
                ...
                <div class='cg_view_options_row'>
                    <div class='cg_view_option cg_view_options_and_order_checkbox_container cg_border_right_none cg_view_option_50_percent SliderLookContainer cg_border_border_bottom_left_radius_8_px'>
                        <div class='cg_view_option_title'>
                         ...
                         <div  class='cg_view_option_radio'>
                            <input type="radio" name="multiple-pics[cg_gallery_no_voting][general][SliderLook]" class="OrderLook" checked="{$jsonOptions[$GalleryID.'-nv']['general']['SliderLook']}">
                         </div>
                    </div>
                ...
                <div class='cg_view_options_row'>
                    <div class='cg_view_option  cg_view_option_100_percent ThumbLookContainer cg_border_radius_8_px'>
                        <div class='cg_view_option_title'>
                         ...
                         <div  class='cg_view_option_radio'>
                            <input type="radio" name="multiple-pics[cg_gallery_no_voting][general][ThumbLook]" class="OrderLook" checked="{$jsonOptions[$GalleryID.'-nv']['general']['ThumbLook']}">
                         </div>
                    </div>
                </div>
                <div class='cg_view_options_row cg_hide'>
...
if(!isset($jsonOptions[$GalleryID.'-nv']['pro']['MainTitleGalleriesView'])){
	$MainTitleGalleriesView = '';
}else{
	$MainTitleGalleriesView = contest_gal1ery_convert_for_html_output_without_nl2br($jsonOptions[$GalleryID.'-nv']['pro']['MainTitleGalleriesView']);
}
...
echo <<<HEREDOC
    <div class='cg_view_options_row' style="margin-top: 15px;">
        <div class='cg_view_option cg_view_option_full_width cg_border_border_top_left_radius_8_px  cg_border_border_top_right_radius_8_px cg_go_to_target' data-cg-go-to-target="MainTitleGalleriesViewArea">
            <div class='cg_view_option_title '>
                <p>Main title cg_galleries_no_voting view</p>
            </div>
            <div class='cg_view_option_input '>
                <input type="text" name='multiple-pics[cg_gallery_no_voting][pro][MainTitleGalleriesView]' class="MainTitleGalleriesView"  value="$MainTitleGalleriesView"  >
            </div>
        </div>
    </div>
HEREDOC;

if(!isset($jsonOptions[$GalleryID.'-nv']['pro']['SubTitleGalleriesView'])){
	$SubTitleGalleriesView = '';
}else{
	$SubTitleGalleriesView = contest_gal1ery_convert_for_html_output_without_nl2br($jsonOptions[$GalleryID.'-nv']['pro']['SubTitleGalleriesView']);
}
...
echo <<<HEREDOC
    <div class='cg_view_options_row'>
        <div class='cg_view_option cg_view_option_full_width cg_border_top_none cg_go_to_target' data-cg-go-to-target="SubTitleGalleriesViewArea">
            <div class='cg_view_option_title '>
                <p>Sub title cg_galleries_no_voting view</p>
            </div>
            <div class='cg_view_option_input '>
                <input type="text" name='multiple-pics[cg_gallery_no_voting][pro][SubTitleGalleriesView]' class="SubTitleGalleriesView"  value="$SubTitleGalleriesView"  >
            </div>
        </div>
    </div>
HEREDOC;

if(!isset($jsonOptions[$GalleryID.'-nv']['pro']['ThirdTitleGalleriesView'])){
	$ThirdTitleGalleriesView = '';
}else{
	$ThirdTitleGalleriesView = contest_gal1ery_convert_for_html_output_without_nl2br($jsonOptions[$GalleryID.'-nv']['pro']['ThirdTitleGalleriesView']);
}
...
echo <<<HEREDOC
    <div class='cg_view_options_row'>
        <div class='cg_view_option cg_view_option_full_width cg_border_top_none  cg_border_border_bottom_left_radius_8_px  cg_border_border_bottom_right_radius_8_px cg_go_to_target $cgProFalse' data-cg-go-to-target="ThirdTitleGalleriesViewArea">
            <div class='cg_view_option_title '>
                <p>Third title cg_galleries_no_voting view
                <br>
            ...
            <div class='cg_view_option_input '>
                <textarea type="text" name='multiple-pics[cg_gallery_no_voting][pro][ThirdTitleGalleriesView]' class="ThirdTitleGalleriesView"  rows="5" style="width:100%;"  >$ThirdTitleGalleriesView</textarea>
            </div>
        </div>
    </div>
HEREDOC;
