...
if(!empty($jsonOptions[$GalleryID.'-u']['visual']['ShowDate'])){
	$ShowDate = '1';
}else{
	$ShowDate = '0';
}
...
echo <<<HEREDOC
        <div class="cg_view_options_row">
                <div class="cg_view_option cg_view_option_50_percent cg_border_top_none cg_border_right_none" >
                    ...
                    <div class="cg_view_option_checkbox cg_view_option_checked">
                        <input type="checkbox" name="multiple-pics[cg_gallery_user][visual][ShowDate]" class="cg_shortcode_checkbox" checked="$ShowDate">
                    </div>
                </div>
HEREDOC;
