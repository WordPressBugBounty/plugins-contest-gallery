...
$PreselectSort_rating_desc_average_selected = ($jsonOptions[$GalleryID.'-u']['pro']['PreselectSort']=='rating_desc_average') ? 'selected' : '';
$PreselectSort_rating_asc_average_selected = ($jsonOptions[$GalleryID.'-u']['pro']['PreselectSort']=='rating_asc_average') ? 'selected' : '';
