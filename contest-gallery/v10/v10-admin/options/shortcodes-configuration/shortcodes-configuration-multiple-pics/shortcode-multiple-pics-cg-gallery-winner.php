...
cg1l_correct_view_options_and_order($order,$jsonOptions[$GalleryID.'-w']['general']['ThumbLook'],$jsonOptions[$GalleryID.'-w']['general']['SliderLook'],$jsonOptions[$GalleryID.'-w']['visual']['BlogLook'],$jsonOptions[$GalleryID.'-w']['general']['HeightLook'],$jsonOptions[$GalleryID.'-w']['general']['RowLook'], true);
        ...
        <div class='cg_view_option_radio_multiple'>
            <div class='cg_view_option_radio_multiple_container ThumbLookContainer cg_one_third_width'>
                ...
                <div class='cg_view_option_radio_multiple_input'>
                    <input type="radio" name="multiple-pics[cg_gallery_winner][general][ThumbLook]" class="OrderLook cg_view_option_radio_multiple_input_field" checked="{$jsonOptions[$GalleryID.'-w']['general']['ThumbLook']}">
                </div>
            </div>
            <div class='cg_view_option_radio_multiple_container SliderLookContainer cg_one_third_width'>
                ...
                <div class='cg_view_option_radio_multiple_input'>
                    <input type="radio" name="multiple-pics[cg_gallery_winner][general][SliderLook]" class="OrderLook cg_view_option_radio_multiple_input_field" checked="{$jsonOptions[$GalleryID.'-w']['general']['SliderLook']}">
                </div>
            </div>
            <div class='cg_view_option_radio_multiple_container BlogLookContainer cg_one_third_width'>
                ...
                <div class='cg_view_option_radio_multiple_input'>
                    <input type="radio" name="multiple-pics[cg_gallery_winner][visual][BlogLook]" class="OrderLook cg_view_option_radio_multiple_input_field" checked="{$jsonOptions[$GalleryID.'-w']['visual']['BlogLook']}">
                </div>
            </div>
        </div>
    </div>
...
<div class='cg_view_options_row'>
    ...
    <div class='cg_view_option cg_view_option_flex_flow_column cg_border_top_none PreselectSortContainer'>
        ...
        <select name='multiple-pics[cg_gallery_winner][pro][PreselectSort]' class='PreselectSort cg_no_outline_and_shadow_on_focus'>
HEREDOC;
...
$PreselectSort_rating_desc_average_selected = ($jsonOptions[$GalleryID.'-w']['pro']['PreselectSort']=='rating_desc_average') ? 'selected' : '';
$PreselectSort_rating_asc_average_selected = ($jsonOptions[$GalleryID.'-w']['pro']['PreselectSort']=='rating_asc_average') ? 'selected' : '';
...
if(isset($jsonOptions[$GalleryID.'-w']['visual']['ShowDate'])){
	$ShowDate = absint($jsonOptions[$GalleryID.'-w']['visual']['ShowDate']);
	if(!in_array($ShowDate,array(0,1,2,3),true)){
		$ShowDate = !empty($jsonOptions[$GalleryID.'-w']['visual']['ShowDate']) ? 1 : 0;
	}
}else{
	$ShowDate = 0;
}
        ...
        <div class="cg_view_options_row">
                <div class="cg_view_option cg_view_option_50_percent cg_border_top_none cg_border_right_none cg_border_bottom_none ShowDateContainer" >
                    ...
                    <div class="cg_view_option_checkbox $ShowDateCheckboxClass">
                        <input type="checkbox" name="multiple-pics[cg_gallery_winner][visual][ShowDate]" class="cg_shortcode_checkbox ShowDate" $ShowDateChecked>
                    </div>
                </div>
HEREDOC;
...
echo <<<HEREDOC
    <div  class='cg_view_option cg_border_top_none cg_border_left_none cg_border_bottom_none cg_view_option_50_percent cg_view_option_flex_flow_column ShowDateFormatContainer $ShowDateDisabledClass'>
        ...
        <div class="cg_view_option_select">
        <select name="multiple-pics[cg_gallery_winner][visual][ShowDateFormat]" class="cg_no_outline_and_shadow_on_focus">
HEREDOC;

// only json option, not in database available
if(!empty($jsonOptions[$GalleryID.'-w']['visual']['ShowDateFormat'])){
	$ShowDateFormat = $jsonOptions[$GalleryID.'-w']['visual']['ShowDateFormat'];
}else{
    ...
    <div class='cg_view_option cg_view_option_full_width cg_border_top_none ShowDateViewContainer $ShowDateDisabledClass'>
        <div class='cg_view_option_radio_multiple'>
            <div class='cg_view_option_radio_multiple_container cg_border_top_none'>
                ...
                <div class='cg_view_option_radio_multiple_input'>
                    <input type="radio" name="multiple-pics[cg_gallery_winner][visual][ShowDateView]" class="cg_view_option_radio_multiple_input_field" $ShowDateView1 value="1" />
                </div>
            </div>
            <div class='cg_view_option_radio_multiple_container cg_border_top_none'>
                <div class='cg_view_option_radio_multiple_title'>
                ...
                <div class='cg_view_option_radio_multiple_input'>
                    <input type="radio" name="multiple-pics[cg_gallery_winner][visual][ShowDateView]" class="cg_view_option_radio_multiple_input_field" $ShowDateView2 value="2" />
                </div>
            </div>
            <div class='cg_view_option_radio_multiple_container cg_border_top_none'>
                <div class='cg_view_option_radio_multiple_title'>
                ...
                <div class='cg_view_option_radio_multiple_input'>
                    <input type="radio" name="multiple-pics[cg_gallery_winner][visual][ShowDateView]" class="cg_view_option_radio_multiple_input_field" $ShowDateView3 value="3" />
                </div>
            </div>
        </div>
    </div>
...
} elseif(!isset($jsonOptions[$GalleryID.'-w']['general']['ShowAlways']) && $ShowAlways != 'checked') {
...
} elseif(!isset($jsonOptions[$GalleryID.'-w']['pro']['RegUserGalleryOnly']) && $RegUserGalleryOnly != 'checked') {
...
if(!isset($jsonOptions[$GalleryID.'-w']['pro']['RegUserGalleryOnlyText'])){
    ...
    $jsonOptions[$GalleryID.'-w']['pro']['RegUserGalleryOnlyText'] = contest_gal1ery_convert_for_html_output_without_nl2br($jsonOptions[$GalleryID.'-w']['pro']['RegUserGalleryOnlyText']);
}
...
HEREDOC;
    ...
    if(floatval($galleryDbVersion)>=24) {
        ...
        if(!isset($jsonOptions[$GalleryID.'-w']['visual']['ShowBackToGalleriesButton'])){
            $jsonOptions[$GalleryID.'-w']['visual']['ShowBackToGalleriesButton'] = 1;
        }
    ...
    <div class='cg_view_options_row'>
        <div class='cg_view_option cg_view_option_100_percent  cg_border_border_top_left_radius_8_px cg_border_border_top_right_radius_8_px  '>
            <div class='cg_view_option_title '>
                ...
                <br><span class="cg_view_option_title_note"><a href="$WpPageParentWinnerPermalink" target="_blank">$WpPageParentWinnerPermalink</a></span></p>
            </div>
        <div class='cg_view_option_checkbox '>
            <input type="checkbox" name='multiple-pics[cg_gallery_winner][visual][ShowBackToGalleriesButton]'  class="cg_shortcode_checkbox ShowBackToGalleriesButton"  checked="{$jsonOptions[$GalleryID.'-w']['visual']['ShowBackToGalleriesButton']}"  >
        </div>
        </div>
    </div>
HEREDOC;
...
HEREDOC;
        ...
        if(!isset($jsonOptions[$GalleryID.'-w']['pro']['BackToGalleriesButtonURL'])){
            $jsonOptions[$GalleryID.'-w']['pro']['BackToGalleriesButtonURL'] = '';
        }else{
            $jsonOptions[$GalleryID.'-w']['pro']['BackToGalleriesButtonURL'] = contest_gal1ery_convert_for_html_output_without_nl2br($jsonOptions[$GalleryID.'-w']['pro']['BackToGalleriesButtonURL']);
        }
    ...
    <div class='cg_view_options_row'>
        <div class='cg_view_option cg_view_option_full_width  cg_border_top_none '>
            <div class='cg_view_option_title '>
                ...
                <br><span class="cg_view_option_title_note"><a href="$WpPageParentWinnerPermalink" target="_blank">$WpPageParentWinnerPermalink</a><br><span class="cg_view_option_title_note">If not set then parent site<br><a target="_blank"  href="$pageGalleries">$pageGalleries</a><br>URL will be used<br><span class="cg_font_weight_500">NOTE: </span> <span class="cg_note_text">has to start with <span class="cg_font_weight_500">http://</span> or <span class="cg_font_weight_500">https://</span>, like https://www.example.com</span></span></p>
            </div>
            <div class='cg_view_option_input '>
                <input type="text" name="multiple-pics[cg_gallery_winner][pro][BackToGalleriesButtonURL]" class="BackToGalleriesButtonURL"  value="{$jsonOptions[$GalleryID.'-w']['pro']['BackToGalleriesButtonURL']}"   >
            </div>
        </div>
    </div>
HEREDOC;
        ...
        if(!isset($jsonOptions[$GalleryID.'-w']['pro']['WpPageParentRedirectURL'])){
            $jsonOptions[$GalleryID.'-w']['pro']['WpPageParentRedirectURL'] = '';
        }else{
...
HEREDOC;
    ...
    // only json option, not in database available
    if(!isset($jsonOptions[$GalleryID.'-w']['visual']['HeaderWpPageParent'])){
        $HeaderWpPageParent = "";
    }else{
        $HeaderWpPageParent = contest_gal1ery_convert_for_html_output_without_nl2br($jsonOptions[$GalleryID.'-w']['visual']['HeaderWpPageParent']);
    }
    ...
    <div class='cg_view_options_row'>
        <div class='cg_view_option cg_view_option_full_width  cg_border_top_none '>
            ...
            <div class='cg_view_option_textarea' >
                <textarea type="text" name="multiple-pics[cg_gallery_winner][visual][HeaderWpPageParent]" rows="7" style="width:100%;" class="HeaderWpPageParent"  >$HeaderWpPageParent</textarea>
            </div>
        </div>
    </div>
HEREDOC;
    ...
    // only json option, not in database available
    if(!isset($jsonOptions[$GalleryID.'-w']['visual']['TextBeforeWpPageParent'])){
        $TextBeforeWpPageParent = "";
    }else{
        $TextBeforeWpPageParent = contest_gal1ery_convert_for_html_output_without_nl2br($jsonOptions[$GalleryID.'-w']['visual']['TextBeforeWpPageParent']);
    }

    echo <<<HEREDOC
<div class='cg_view_options_row'>
    <div class='cg_view_option cg_view_option_full_width cg_border_top_none' id="wp-TextBeforeWpPageParentWinner-wrap-Container">
        <div class='cg_view_option_title'>
        ...
        <div class='cg_view_option_html'>
            <textarea class='cg-wp-editor-template' name='multiple-pics[cg_gallery_winner][visual][TextBeforeWpPageParent]'  id='TextBeforeWpPageParentWinner'>$TextBeforeWpPageParent</textarea>
        </div>
    </div>
</div>
HEREDOC;
    ...
    // only json option, not in database available
    if(!isset($jsonOptions[$GalleryID.'-w']['visual']['TextAfterWpPageParent'])){
        $TextAfterWpPageParent = "";
    }else{
        $TextAfterWpPageParent = contest_gal1ery_convert_for_html_output_without_nl2br($jsonOptions[$GalleryID.'-w']['visual']['TextAfterWpPageParent']);
    }

    echo <<<HEREDOC
<div class='cg_view_options_row'>
    <div class='cg_view_option cg_view_option_full_width cg_border_top_none' id="wp-TextAfterWpPageParentWinner-wrap-Container">
        <div class='cg_view_option_title'>
        ...
        <div class='cg_view_option_html'>
            <textarea class='cg-wp-editor-template' name='multiple-pics[cg_gallery_winner][visual][TextAfterWpPageParent]'  id='TextAfterWpPageParentWinner'>$TextAfterWpPageParent</textarea>
        </div>
    </div>
</div>
HEREDOC;
                    ...
                    <div class='cg_view_option cg_view_options_and_order_checkbox_container cg_view_option_100_percent BlogLookContainer cg_border_radius_8_px'>
                        <div class='cg_view_option_title'>
                         ...
                         <div  class='cg_view_option_radio'>
                            <input type="radio" name="multiple-pics[cg_gallery_winner][visual][BlogLook]" class="OrderLook" checked="{$jsonOptions[$GalleryID.'-w']['visual']['BlogLook']}">
                         </div>
                    </div>
                </div>
            </div>
                ...
                <div class='cg_view_options_row'>
                    <div class='cg_view_option cg_view_options_and_order_checkbox_container cg_border_right_none cg_view_option_50_percent SliderLookContainer cg_border_border_bottom_left_radius_8_px'>
                        <div class='cg_view_option_title'>
                         ...
                         <div  class='cg_view_option_radio'>
                            <input type="radio" name="multiple-pics[cg_gallery_winner][general][SliderLook]" class="OrderLook" checked="{$jsonOptions[$GalleryID.'-w']['general']['SliderLook']}">
                         </div>
                    </div>
                ...
                <div class='cg_view_options_row'>
                    <div class='cg_view_option  cg_view_option_100_percent ThumbLookContainer cg_border_radius_8_px'>
                        <div class='cg_view_option_title'>
                         ...
                         <div  class='cg_view_option_radio'>
                            <input type="radio" name="multiple-pics[cg_gallery_winner][general][ThumbLook]" class="OrderLook" checked="{$jsonOptions[$GalleryID.'-w']['general']['ThumbLook']}">
                         </div>
                    </div>
                </div>
                <div class='cg_view_options_row cg_hide'>
...
if(!isset($jsonOptions[$GalleryID.'-w']['pro']['MainTitleGalleriesView'])){
	$MainTitleGalleriesView = '';
}else{
	$MainTitleGalleriesView = contest_gal1ery_convert_for_html_output_without_nl2br($jsonOptions[$GalleryID.'-w']['pro']['MainTitleGalleriesView']);
}
...
echo <<<HEREDOC
    <div class='cg_view_options_row' style="margin-top: 15px;">
        <div class='cg_view_option cg_view_option_full_width cg_border_border_top_left_radius_8_px  cg_border_border_top_right_radius_8_px cg_go_to_target' data-cg-go-to-target="MainTitleGalleriesViewArea">
            <div class='cg_view_option_title '>
                <p>Main title cg_galleries_winner view</p>
            </div>
            <div class='cg_view_option_input '>
                <input type="text" name='multiple-pics[cg_gallery_winner][pro][MainTitleGalleriesView]' class="MainTitleGalleriesView"  value="$MainTitleGalleriesView"  >
            </div>
        </div>
    </div>
HEREDOC;

if(!isset($jsonOptions[$GalleryID.'-w']['pro']['SubTitleGalleriesView'])){
	$SubTitleGalleriesView = '';
}else{
	$SubTitleGalleriesView = contest_gal1ery_convert_for_html_output_without_nl2br($jsonOptions[$GalleryID.'-w']['pro']['SubTitleGalleriesView']);
}
...
echo <<<HEREDOC
    <div class='cg_view_options_row'>
        <div class='cg_view_option cg_view_option_full_width cg_border_top_none cg_go_to_target' data-cg-go-to-target="SubTitleGalleriesViewArea">
            <div class='cg_view_option_title '>
                <p>Sub title cg_galleries_winner view</p>
            </div>
            <div class='cg_view_option_input '>
                <input type="text" name='multiple-pics[cg_gallery_winner][pro][SubTitleGalleriesView]' class="SubTitleGalleriesView"  value="$SubTitleGalleriesView"  >
            </div>
        </div>
    </div>
HEREDOC;

if(!isset($jsonOptions[$GalleryID.'-w']['pro']['ThirdTitleGalleriesView'])){
	$ThirdTitleGalleriesView = '';
}else{
	$ThirdTitleGalleriesView = contest_gal1ery_convert_for_html_output_without_nl2br($jsonOptions[$GalleryID.'-w']['pro']['ThirdTitleGalleriesView']);
}
...
echo <<<HEREDOC
    <div class='cg_view_options_row'>
        <div class='cg_view_option cg_view_option_full_width cg_border_top_none  cg_border_border_bottom_left_radius_8_px  cg_border_border_bottom_right_radius_8_px cg_go_to_target $cgProFalse' data-cg-go-to-target="ThirdTitleGalleriesViewArea">
            <div class='cg_view_option_title '>
                <p>Third title cg_galleries_winner view
                <br>
            ...
            <div class='cg_view_option_input '>
                <textarea type="text" name='multiple-pics[cg_gallery_winner][pro][ThirdTitleGalleriesView]' class="ThirdTitleGalleriesView"  rows="5" style="width:100%;"  >$ThirdTitleGalleriesView</textarea>
            </div>
        </div>
    </div>
HEREDOC;
