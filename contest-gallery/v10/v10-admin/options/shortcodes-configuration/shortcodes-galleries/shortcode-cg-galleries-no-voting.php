...
if(!isset($galleriesOptions['nv']['HeaderWpPageGalleries'])){
    $HeaderWpPageGalleries = "";
}else{
    $HeaderWpPageGalleries = contest_gal1ery_convert_for_html_output_without_nl2br($galleriesOptions['nv']['HeaderWpPageGalleries']);
}
    ...
    <div class='cg_view_options_row'>
        <div class='cg_view_option cg_view_option_full_width  cg_border_top_none '>
            ...
            <div class='cg_view_option_textarea' >
                <textarea type="text" name="cg_galleries[nv][HeaderWpPageGalleries]" rows="7" style="width:100%;" class="HeaderWpPageGalleries"  >$HeaderWpPageGalleries</textarea>
            </div>
        </div>
    </div>
HEREDOC;
...
// only json option, not in database available
if(!isset($galleriesOptions['nv']['TextBeforeWpPageGalleries'])){
    $TextBeforeWpPageGalleries = "";
}else{
    $TextBeforeWpPageGalleries = contest_gal1ery_convert_for_html_output_without_nl2br($galleriesOptions['nv']['TextBeforeWpPageGalleries']);
}

echo <<<HEREDOC
<div class='cg_view_options_row'>
    <div class='cg_view_option cg_view_option_full_width cg_border_top_none' id="wp-TextBeforeWpPageGalleriesNoVoting-wrap-Container">
        <div class='cg_view_option_title'>
        ...
        <div class='cg_view_option_html'>
            <textarea class='cg-wp-editor-template' name='cg_galleries[nv][TextBeforeWpPageGalleries]'  id='TextBeforeWpPageGalleriesNoVoting'>$TextBeforeWpPageGalleries</textarea>
        </div>
    </div>
</div>
HEREDOC;
...
// only json option, not in database available
if(!isset($galleriesOptions['nv']['TextAfterWpPageGalleries'])){
    $TextAfterWpPageGalleries = "";
}else{
    $TextAfterWpPageGalleries = contest_gal1ery_convert_for_html_output_without_nl2br($galleriesOptions['nv']['TextAfterWpPageGalleries']);
}

echo <<<HEREDOC
<div class='cg_view_options_row'>
    <div class='cg_view_option cg_view_option_full_width cg_border_top_none' id="wp-TextAfterWpPageGalleriesNoVoting-wrap-Container">
        <div class='cg_view_option_title'>
        ...
        <div class='cg_view_option_html'>
            <textarea class='cg-wp-editor-template' name='cg_galleries[nv][TextAfterWpPageGalleries]'  id='TextAfterWpPageGalleriesNoVoting'>$TextAfterWpPageGalleries</textarea>
        </div>
    </div>
</div>
HEREDOC;

if(!empty($galleriesOptions['nv']['GalleriesPagesNoIndex'])){
            ...
            <div class="cg_view_option cg_view_option_100_percent cg_border_top_none" id="GalleriesPagesNoIndexContainer">
                <div class="cg_view_option_title">
                    <p style="margin-right: -30px;">
                        Allow search engines like Google to index the original Contest Gallery URLs under /contest-galleries-no-voting...
                ...
                <div class="cg_view_option_checkbox cg_view_option_checked">
                    <input type="checkbox" name="cg_galleries[nv][GalleriesPagesNoIndex]" id="GalleriesPagesNoIndex" $GalleriesPagesNoIndex>
                </div>
            </div>
    </div>
HEREDOC;

if(!empty($galleriesOptions['nv']['GalleriesPagesNoFollow'])){
...
echo <<<HEREDOC
       <div class="cg_view_options_row cg_border_top_none">
            <div class="cg_view_option cg_view_option_100_percent cg_border_top_none" id="GalleriesPagesNoIndexContainer">
                ...
                <div class="cg_view_option_checkbox cg_view_option_checked">
                    <input type="checkbox" name="cg_galleries[nv][GalleriesPagesNoFollow]" id="GalleriesPagesNoFollow" $GalleriesPagesNoFollow>
                </div>
            </div>
    </div>
HEREDOC;
