...
if(!empty($options[$GalleryID])){
    ...
    $options[$GalleryID.'-ec']['pro']['ShowOther'] = $ShowOther;
    $options[$GalleryID.'-ec']['pro']['CatWidget'] = $CatWidget;
    $options[$GalleryID.'-ec']['pro']['ShowCatsUnchecked'] = $ShowCatsUnchecked;
    $options[$GalleryID.'-ec']['pro']['ShowCatsUnfolded'] = $ShowCatsUnfolded;
}else{
