...
$wpdb->update(
    "$tablenameOptions",
    array(
        'WpPageParent' => $WpPageParent,'WpPageParentUser' => $WpPageParentUser,'WpPageParentNoVoting' => $WpPageParentNoVoting,'WpPageParentWinner' => $WpPageParentWinner,'WpPageParentEcommerce' => $WpPageParentEcommerce
    ),
...
if(file_exists($jsonOptionsGalleryPrev)){
    ...
    if(!empty($jsonOptionsPrev[$idToCopy])){
        ...
        if(!empty($jsonOptionsPrev[$idToCopy.'-ec'])){
            if(!empty($jsonOptionsPrev[$idToCopy.'-ec']['general'])){
                $jsonOptionsPrev[$idToCopy.'-ec']['general']['Version'] = $VersionForScripts;// update db version here additionally requires
                $jsonOptionsPrev[$idToCopy.'-ec']['general']['VersionDecimal'] = $VersionDecimal;// update version decimal here requires
                $jsonOptionsPrev[$idToCopy.'-ec']['pro']['FbLikeNoShare'] = 0;
                $jsonOptionsPrev[$idToCopy.'-ec']['pro']['FbLikeOnlyShare'] = 0;
                $jsonOptionsPrev[$idToCopy.'-ec']['general']['FbLike'] = 0;
                $jsonOptionsPrev[$idToCopy.'-ec']['general']['FbLikeGallery'] = 0;
                $jsonOptionsPrev[$idToCopy.'-ec']['general']['FbLikeGoToGalleryLink'] = '';
            }
        }
		...
		// since version 22 and higher
	    //if(!empty($jsonOptionsPrev[$idToCopy.'-ec'])){
	    if($cgVersion<22){// has to be checked this way, older galleries might contain some -ec already through saving
		    $jsonOptions[$nextIDgallery.'-ec'] = $jsonOptionsPrev[$idToCopy];
	    }else{
        ...
        if(!empty($Field2IdGalleryView)){
            ...
            $jsonOptions[$nextIDgallery.'-w']['visual']['Field2IdGalleryView'] = $Field2IdGalleryView;
            $jsonOptions[$nextIDgallery.'-ec']['visual']['Field2IdGalleryView'] = $Field2IdGalleryView;
        }
        if(!empty($Field3IdGalleryView)){
            ...
            $jsonOptions[$nextIDgallery.'-ec']['visual']['Field3IdGalleryView'] = $Field3IdGalleryView;
        }
        if(!empty($newSubTitleFieldId)){
            ...
            $jsonOptions[$nextIDgallery.'-ec']['visual']['SubTitle'] = $newSubTitleFieldId;
        }
        if(!empty($newThirdTitleFieldId)){
            ...
            $jsonOptions[$nextIDgallery.'-ec']['visual']['ThirdTitle'] = $newThirdTitleFieldId;
        }
        ...
        if(!empty($jsonOptions[$nextIDgallery.'-ec']['general']['AllowGalleryScript'])){
            $jsonOptions[$nextIDgallery.'-ec']['pro']['SliderFullWindow'] = 0;
            $jsonOptions[$nextIDgallery.'-ec']['visual']['BlogLookFullWindow'] = 1;
        }
        ...
        $jsonOptions[$nextIDgallery.'-ec']['general']['FullSizeSlideOutStart'] = 0;
        ...
        if ($cgVersion < 21) {
            ...
            $jsonOptions[$nextIDgallery.'-ec']['visual']['ShareButtons'] = $ShareButtons;
            ...
            $jsonOptions[$nextIDgallery.'-ec']['visual']['ForwardToWpPageEntry'] = $ForwardToWpPageEntry;
            ...
            $jsonOptions[$nextIDgallery.'-ec']['visual']['BackToGalleryButtonText'] = $BackToGalleryButtonText;
            ...
            $jsonOptions[$nextIDgallery.'-ec']['visual']['TextDeactivatedEntry'] = $TextDeactivatedEntry;
            ...
            $jsonOptions[$nextIDgallery.'-ec']['visual']['AdditionalCssEntryLandingPage'] = $AdditionalCssEntryLandingPage;
        ...
        $jsonOptions[$nextIDgallery.'-ec']['general']['ShowAlways'] = 3;
        ...
        $jsonOptions[$nextIDgallery.'-ec']['general']['WpPageParent'] = $WpPageParent;
        ...
        $jsonOptions[$nextIDgallery.'-ec']['general']['WpPageParentUser'] = $WpPageParentUser;
        ...
        $jsonOptions[$nextIDgallery.'-ec']['general']['WpPageParentNoVoting'] = $WpPageParentNoVoting;
        ...
        $jsonOptions[$nextIDgallery.'-ec']['general']['WpPageParentWinner'] = $WpPageParentWinner;

        $jsonOptions[$nextIDgallery]['general']['WpPageParentEcommerce'] = $WpPageParentEcommerce;
        $jsonOptions[$nextIDgallery.'-u']['general']['WpPageParentEcommerce'] = $WpPageParentEcommerce;
        $jsonOptions[$nextIDgallery.'-nv']['general']['WpPageParentEcommerce'] = $WpPageParentEcommerce;
        $jsonOptions[$nextIDgallery.'-w']['general']['WpPageParentEcommerce'] = $WpPageParentEcommerce;
        $jsonOptions[$nextIDgallery.'-ec']['general']['WpPageParentEcommerce'] = $WpPageParentEcommerce;
