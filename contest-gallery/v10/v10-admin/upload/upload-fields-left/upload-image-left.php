...
$selectFormInput[$key]->bhCount = $bhCount;
...
echo "<div id='$bhCount' class='formField imageUploadField cg_hide' ><input type='hidden' name='upload[$id][type]' value='bh'>";
...
if(floatval($dbGalleryVersion)>=26.03){
	...
	if(!isset($fieldContent['collapsed'])){
		$collapsedChecked = 'checked';
	}elseif($fieldContent['collapsed']=='on'){
		$collapsedChecked = 'checked';
	}else{
		$collapsedChecked = '';
	}
...
foreach($fieldContent as $key => $valueFieldContent){
    ...
    if($key=='titel'){
        ...
        echo <<<HEREDOC
<div id="cgEditImageField" class="cg_view_options_row cg_view_options_row_title cg_view_options_row_collapse" title="Collapse">
...
<div class='cg_view_options_row'>
  <div class='cg_view_option cg_view_option_flex_flow_column cg_view_option_100_percent cg_border_bottom_none'>
...
HEREDOC;
    ...
    <div  class='cg_view_option cg_view_option_50_percent  cg_border_bottom_none cg_view_option_flex_flow_column'>
        ...
        <div class='cg-config' style='margin-top:-5px;'><a href='?page=$cg_get_version/index.php&edit_options=true&option_id=$GalleryID&cg_go_to=cgActivatePostMaxMBfileContainerRow' target='_blank'><b>Config here</b></a></div>
        </div>
    </div>
</div>
HEREDOC;
