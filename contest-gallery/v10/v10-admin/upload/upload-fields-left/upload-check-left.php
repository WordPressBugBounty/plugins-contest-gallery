...
if(!$isOnlyPlaceHolder){
    ...
    $selectFormInput[$key]->chkCount = $chkCount;
...
$valueFieldTitle = 'Checkbox';

// Anfang des Formularteils
echo "<div id='$chkCount'  class='formField checkField cg_hide'><input type='hidden' name='upload[$id][type]' value='chk'>";
...
echo <<<HEREDOC
<div id="cgEditCheckField"  class="cg_view_options_row cg_view_options_row_title cg_view_options_row_collapse" title="Collapse">
...
<div class='cg_view_option cg_view_option_100_percent  cg_border_bottom_none  cg_view_option_flex_flow_column'>
        <div class='cg_view_option_title cg_view_option_title_full_width '>
            <p>Checkbox<br>
                <span class="cg_view_option_title_note"><b>NOTE:</b> <span class="cg_note_text">Each row one checkbox button</span></span><br><br></p>
        </div>
        <div class="cg_view_option_input_full_width" >
            <textarea name='upload[$id][content]' maxlength='10000' style='width:100%;' placeholder='Each row one checkbox button - Example: &#10;button1&#10;button2&#10;button3&#10;button4&#10;button5&#10;button6'  rows='6' class="cg_check_placeholder" >$valueFieldPlaceholder</textarea>
        </div>
    </div>
</div>
HEREDOC;
