...
if(!$isOnlyPlaceHolder){
    ...
    $selectFormInput[$key]->dtCount = $dtCount;
    ...
    $selectFormInput[$key]->dCount = $dtCount;
...
echo "<div id='$dtCount'  class='formField dateTimeField cg_hide'><input type='hidden' name='upload[$id][type]' value='dt'>";
...
echo <<<HEREDOC
<div id="cgEditDateField" class="cg_view_options_row cg_view_options_row_title cg_view_options_row_collapse" title="Collapse">
        ...
        <div class="cg_view_option cg_view_option_not_disable cg_border_left_none cg_border_top_none cg_border_bottom_none cg_view_option_100_percent">
...
echo <<<HEREDOC
<div class='cg_view_options_row'>
   	<div class='cg_view_option cg_border_bottom_none cg_view_option_100_percent  cg_view_option_flex_flow_column'>
        <div class='cg_view_option_title cg_view_option_title_full_width '>
...
echo <<<HEREDOC
<div class='cg_view_options_row'>
     <div class='cg_view_option cg_view_option_100_percent cg_border_top_none cg_border_bottom_none  cg_info_show_gallery'>
        <div class='cg_view_option_title cg_view_option_title_full_width '>
