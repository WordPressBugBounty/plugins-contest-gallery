...
if(!$isOnlyPlaceHolder){
    ...
    $selectFormInput[$key]->secCount = $secCount;
...
echo "<div id='$secCount'  class='formField cg_sec_field selectCategoriesField cg_hide' >";
echo "<div class='cg_remove cg_is_category_main_field cg_hide' title='Remove field' data-cg-id='$id'></div>";
echo "<div class='cg_drag_area cg_hide' id='cgSelectCategoriesField'><img class='cg_drag_area_icon' src='$cgDragIcon'></div>";
...
if($checkCategory==false){
    ...
    echo '<div id="cgCategoryFieldDivOther">
                    <input class="cg_category_field cg_disabled" value="Other" type="text" style="margin-left: 0;border-radius: 5px;" />
                     &nbsp;All uncategorized files has category <b>Other</b>. Frontend translation for <b>Other</b> in  can be found <a 
                      href="?page='.cg_get_version().'/index.php&edit_options=true&option_id='.$GalleryID.'&cg_edit_translations=true&cg_go_to=cgTranslationOther" target="_blank">here...</a>
                    </div>';
...
echo <<<HEREDOC
<div class='cg_view_options_row'>
    <div class='cg_view_option $cgProFalse cg_view_option_watermark cg_border_bottom_none cg_view_option_100_percent '>
        <div class='cg_view_option_title '>
...
echo <<<HEREDOC
<div class='cg_view_options_row'>
     <div  class='cg_view_option cg_view_option_100_percent $cgProFalse  cg_view_option_not_disable  cg_border_bottom_none cg_view_option_watermark_position cg_view_option_flex_flow_column $watermarkPositionDisabled'>
