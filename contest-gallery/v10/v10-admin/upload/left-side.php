...
if(true){
    ...
    include (__DIR__.'/fields-left/check-agreement-left.php');

    include (__DIR__.'/fields-left/date-left.php');

    include (__DIR__.'/fields-left/input-left.php');

    include (__DIR__.'/fields-left/url-left.php');

    include (__DIR__.'/fields-left/email-left.php');

    include (__DIR__.'/fields-left/textarea-left.php');

    include (__DIR__.'/fields-left/html-left.php');

    //include (__DIR__.'/fields/htmlf-left.php');// ht not works if this is inserted, no clue where it comes from

    include (__DIR__.'/fields-left/simple-captcha-left.php');

    include (__DIR__.'/fields-left/google-captcha-left.php');

    include (__DIR__.'/fields-left/select-left.php');

    include (__DIR__.'/fields-left/select-categories-left.php');
...
foreach ($selectFormInput as $key => $value) {
    if($value->Field_Type == 'image-f'){
        include (__DIR__.'/fields-left/image-left.php');
    }
}
...
foreach ($selectFormInput as $key => $value) {
    ...
    if($value->Field_Type == 'htmlf-f'){
        include (__DIR__.'/fields-left/htmlf-left.php');
    }
