...
if($isOnlyPlaceHolder){
    ...
    $nfRightCount = $value->nfCount;
    $cg_el_saved = "cg_el_saved";
}

$colId = 'nf';

    echo "<div class='cg_row_col cg_el cg_drag_drop $cg_hide_upload_field $cg_el_saved' title='Edit field' id='right$nfRightCount' data-cg-field='$colId' draggable='true'
