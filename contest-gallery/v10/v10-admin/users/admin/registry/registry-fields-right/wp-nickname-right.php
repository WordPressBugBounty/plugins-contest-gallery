...
$colId = '';
    ...
    echo "<div class='cg_row_col cg_el cg_drag_drop $cg_hide_upload_field $cg_el_saved' title='Edit field' id='rightcg_main-nick-name' data-cg-field='$colId' draggable='true'
