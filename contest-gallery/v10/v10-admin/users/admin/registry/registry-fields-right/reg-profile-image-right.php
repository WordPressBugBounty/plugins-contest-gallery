...
if($isOnlyPlaceHolder){
    ...
    $piRightCount = $value->piCount;
    $cg_el_saved = "cg_el_saved";
}

$colId = 'pi';

    echo "<div class='cg_row_col cg_el cg_drag_drop $cg_hide_upload_field $cg_el_saved' title='Edit field' id='right$piRightCount' data-cg-field='$colId' draggable='true'
...
if($PinField){
    ...
    echo "</div>";
            ...
            echo "<div class='cg_upl_content' >";
                echo "<input class='cg_upl_placeholder' placeholder='$fieldPlaceholder' type='file' >";
            echo "</div>";
