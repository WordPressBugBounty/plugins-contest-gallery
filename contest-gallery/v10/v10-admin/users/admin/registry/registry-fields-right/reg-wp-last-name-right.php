...
if($isOnlyPlaceHolder){
    ...
    $wplnRightCount = $value->wplnCount;
    $cg_el_saved = "cg_el_saved";
}

$colId = 'wpln';

echo "<div class='cg_row_col cg_el cg_drag_drop $cg_hide_upload_field $cg_el_saved' title='Edit field' id='right$wplnRightCount' data-cg-field='$colId' draggable='true'
