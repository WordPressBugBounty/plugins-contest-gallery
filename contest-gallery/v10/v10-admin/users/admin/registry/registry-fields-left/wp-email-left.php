...
if(!$isOnlyPlaceHolder){
    ...
    $value->PinField = 1;// always on for email
    if($value->PinField==1){
...
echo "<div id='cg_main-mail'  class='formField cg_hide'>";
...
$loginTranslationUrl = '?page='.cg_get_version().'/index.php&edit_options=true&option_id='.$GalleryID.'&cg_edit_translations=true&cg_go_to=cgTranslationLanguageEmail';

echo <<<HEREDOC
<div id="cgEditWpEmailField"  class="cg_view_options_row cg_view_options_row_title cg_view_options_row_collapse" title="Collapse">
...
<div class='cg_view_options_row'>
     <div class='cg_view_option cg_border_bottom_none cg_view_option_100_percent cg_pin_field_check cg_pointer_events_none'>
        <div class='cg_view_option_title cg_view_option_title_full_width'>
            <p>Show in [cg_users_pin] form<span class="cg_view_option_pin"></span><br><span class="cg_view_option_title_note"><b>NOTE:</b> WP-Email is always visible in user form for PIN verification</span></p>
        </div>
        <div class="cg_view_option_checkbox cg_visibility_hidden">
