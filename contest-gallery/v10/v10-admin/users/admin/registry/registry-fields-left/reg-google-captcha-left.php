...
if(!$isOnlyPlaceHolder){
    ...
    $selectFormInput[$key]->caRoReCount = $caRoReCount;
...
echo "<div id='$caRoReCount'  class='formField cg_hide regCaptchaRoReField'>";
...
echo <<<HEREDOC
<div id="cgEditCaptchaRoReFieldField"  class="cg_view_options_row cg_view_options_row_title cg_view_options_row_collapse" title="Collapse">
        <div class="cg_view_option cg_border_left_top_none cg_view_option_not_disable cg_border_bottom_none cg_view_option_full_width cg_view_option_flex_flow_column">
...
<div class='cg_view_options_row'>
     <div class='cg_view_option cg_border_bottom_none cg_view_option_100_percent cg_pin_field_check'>
        <div class='cg_view_option_title cg_view_option_title_full_width'>
            <p>Show in [cg_users_pin] form<span class="cg_view_option_pin"></span><br><span class="cg_view_option_title_note"><b>NOTE:</b> not available so far for cg_users_pin form</span></p>
        </div>
