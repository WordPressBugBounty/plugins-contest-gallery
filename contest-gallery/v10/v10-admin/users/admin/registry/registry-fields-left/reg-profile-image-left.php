...
if(!$isOnlyPlaceHolder){
    ...
    $selectFormInput[$key]->piCount = $piCount;
...
echo "<div id='$piCount'  class='formField cg_hide regProfileImageField'>";
...
echo <<<HEREDOC
<div  id="cgEditProfileImageField"  class="cg_view_options_row cg_view_options_row_title cg_view_options_row_collapse" title="Collapse">
