...
echo "<div  id='cg_password-confirm'   class='formField cg_hide'>";
...
$loginTranslationUrl = '?page='.cg_get_version().'/index.php&edit_options=true&cg_edit_translations=true&option_id='.$GalleryID.'&cg_go_to=cgTranslationLanguagePasswordConfirm';

echo <<<HEREDOC
<div  id="cgEditWpPasswordConfirmField"  class="cg_view_options_row cg_view_options_row_title cg_view_options_row_collapse" title="Collapse">
