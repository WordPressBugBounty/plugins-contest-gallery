...
echo "<div id='$chkCount'  class='formField cg_hide regCheckField'>";
...
echo "<input type='hidden' class='Field_Type' name='Field_Type[$i]' value='user-check-field'>";
...
<div class='cg_view_options_row'>
     <div class='cg_view_option cg_view_option_100_percent  cg_border_bottom_none cg_view_option_flex_flow_column'>
        ...
        <div class="cg_view_option_input_full_width" >
            <textarea class="Field_Content cg_check_placeholder" name='Field_Content[$i]' maxlength='10000' style='width:100%;' placeholder='Each row one value - Example: &#10;value1&#10;value2&#10;value3&#10;value4&#10;value5&#10;value6'  rows='6' >$Field_Content</textarea>
        </div>
    </div>
</div>
HEREDOC;
