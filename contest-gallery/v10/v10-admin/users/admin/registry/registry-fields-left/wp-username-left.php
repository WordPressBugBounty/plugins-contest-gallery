...
echo "<div id='cg_main-user-name' class='formField cg_hide'>";
...
echo <<<HEREDOC
<div id="cgEditWpUsernameField" class="cg_view_options_row cg_view_options_row_collapse cg_view_options_row_title" >
        ...
        <div class="cg_view_option cg_border_left_top_none  cg_border_top_right_radius_none  cg_view_option_header  cg_view_option_not_disable cg_border_bottom_none cg_view_option_full_width cg_view_option_flex_flow_column">
