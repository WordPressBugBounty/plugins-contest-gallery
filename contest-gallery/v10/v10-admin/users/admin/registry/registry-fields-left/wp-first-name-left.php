...
if(!$isOnlyPlaceHolder){
    ...
    $selectFormInput[$key]->wpfnCount = $wpfnCount;
...
echo "<div id='$wpfnCount'  class='formField wpFirstNameField cg_hide'>";
...
echo <<<HEREDOC
<div id="cgEditWpFirstNameField" class="cg_view_options_row cg_view_options_row_title cg_view_options_row_collapse" title="Collapse">
