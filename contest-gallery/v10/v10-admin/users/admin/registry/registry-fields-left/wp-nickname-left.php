...
echo "<div  id='cg_main-nick-name' class='formField cg_hide'>";
...
echo <<<HEREDOC
<div  id="cgEditWpNicknameField"  class="cg_view_options_row cg_view_options_row_title cg_view_options_row_collapse" title="Collapse">
        ...
        <div class="cg_view_option cg_border_left_none cg_border_top_none cg_view_option_header  cg_view_option_not_disable cg_border_bottom_none cg_view_option_full_width cg_view_option_flex_flow_column">
