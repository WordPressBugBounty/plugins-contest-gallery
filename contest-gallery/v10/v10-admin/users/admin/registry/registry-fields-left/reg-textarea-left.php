...
echo "<div id='$kfCount'  class='formField cg_hide regTextareaField'>";
...
<div class='cg_view_options_row'>
     <div class='cg_view_option cg_view_option_100_percent  cg_border_bottom_none cg_view_option_flex_flow_column'>
        ...
        <div class="cg_view_option_input_full_width" >
            <textarea class="Field_Content cg_title_placeholder" name='Field_Content[$i]' maxlength='10000' style='width:100%;' placeholder=''  rows='6' >$Field_Content</textarea>
        </div>
    </div>
</div>
HEREDOC;
...
<div class='cg_view_options_row'>
    <div  class='cg_view_option cg_view_option_50_percent  cg_border_right_none cg_border_bottom_none cg_view_option_flex_flow_column'>
        ...
        <div class="cg_view_option_input cg_view_option_input_full_width" >
            <input type="text" class="Min_Char" name="Min_Char[$i]" value="$Min_Char"  maxlength="5">
        </div>
    </div>
     <div class='cg_view_option cg_view_option_50_percent  cg_border_bottom_none cg_view_option_flex_flow_column'>
        ...
        <div class="cg_view_option_input cg_view_option_input_full_width" >
            <input type="text" class="Max_Char"  name="Max_Char[$i]" value="$Max_Char"  maxlength="5">
        </div>
    </div>
</div>
HEREDOC;
...
echo <<<HEREDOC
<div class='cg_view_options_row'>
    <div  class='cg_view_option cg_view_option_required cg_view_option_required cg_view_option_50_percent cg_border_right_none '>
        <div class='cg_view_option_title cg_view_option_title_full_width '>
            <p>Required</p>
        </div>
        <div class="cg_view_option_checkbox">
