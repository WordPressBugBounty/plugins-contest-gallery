...
if(!$isOnlyPlaceHolder){
    ...
    $selectFormInput[$key]->wplnCount = $wplnCount;
...
echo "<div id='$wplnCount'  class='formField wpLastNameField cg_hide'>";
...
echo <<<HEREDOC
<div id="cgEditWpLastNameField" class="cg_view_options_row cg_view_options_row_title cg_view_options_row_collapse" title="Collapse">
