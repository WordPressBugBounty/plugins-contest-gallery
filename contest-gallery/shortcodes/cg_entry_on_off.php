            ...
            if($cg_hash!=$cg_hash_to_compare){
                ...
                if(empty($objectRow)){
                    ...
                    if($isActivate){
                        ...
                        $WpPageEcommerce = $objectRow->WpPageEcommerce;
                        ...
                        cg_create_json_files_when_activating($GalleryID,$objectRow,$thumbSizesWp,$uploadFolder,$imageArray);
                       ...
                       cg_json_upload_form_info_data_files_new($GalleryID);
                        ...
                        if(floatval($galleryDBversion)>=22){
                            if(get_post_status( $WpPageEcommerce ) == 'trash'){
                                ...
                                $permalink = get_permalink($WpPageEcommerce);
                                if($permalink===false){
                                    echo "<div class='cg_entry_on_off_link'>";
                                    echo "<a href='#' target='_blank' class='cg_entry_page_url cg_disabled_background_color_e0e0e0 cg_display_inline_block'>";
