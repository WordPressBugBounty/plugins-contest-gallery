...
// translations-previous.json will be definetly generated in cg_convert_previous_translation_to_general_translations
...
__('Service');$l_Service = "Service"; $language_Service = (!empty($translations[$l_Service]) && $is_frontend) ? $translations[$l_Service] : ((empty(trim(__($l_Service,$domain)))) ? __($l_Service,$domainDefault) : __($l_Service,$domain)); if(empty($translations[$l_Service])){$translations[$l_Service]='';}
...
__('Only visible to registered and logged in owner of the entry');$l_OnlyVisibleForRegisteredAndLoggedInOwner = "Only visible to registered and logged in owner of the entry";$language_OnlyVisibleForRegisteredAndLoggedInOwner = (!empty($translations[$l_OnlyVisibleForRegisteredAndLoggedInOwner]) && $is_frontend) ? $translations[$l_OnlyVisibleForRegisteredAndLoggedInOwner] : ((empty(trim(__($l_OnlyVisibleForRegisteredAndLoggedInOwner,$domain)))) ? __($l_OnlyVisibleForRegisteredAndLoggedInOwner,$domainDefault) : __($l_OnlyVisibleForRegisteredAndLoggedInOwner,$domain)); if(empty($translations[$l_OnlyVisibleForRegisteredAndLoggedInOwner])){$translations[$l_OnlyVisibleForRegisteredAndLoggedInOwner]='';}
...
__('Slow down, you are too fast. Please wait a moment before sending another comment.');$l_SlowDownComment = "Slow down, you are too fast. Please wait a moment before sending another comment.";$language_SlowDownComment = (!empty($translations[$l_SlowDownComment]) && $is_frontend) ? $translations[$l_SlowDownComment] : ((empty(trim(__($l_SlowDownComment,$domain)))) ? __($l_SlowDownComment,$domainDefault) : __($l_SlowDownComment,$domain)); if(empty($translations[$l_SlowDownComment])){$translations[$l_SlowDownComment]='';}
...
__('You cannot vote for your own entry');$l_ItIsNotAllowedToVoteForYourOwnPicture = "You cannot vote for your own entry";$language_ItIsNotAllowedToVoteForYourOwnPicture = (!empty($translations[$l_ItIsNotAllowedToVoteForYourOwnPicture]) && $is_frontend) ? $translations[$l_ItIsNotAllowedToVoteForYourOwnPicture] : ((empty(trim(__($l_ItIsNotAllowedToVoteForYourOwnPicture,$domain)))) ? __($l_ItIsNotAllowedToVoteForYourOwnPicture,$domainDefault) : __($l_ItIsNotAllowedToVoteForYourOwnPicture,$domain)); if(empty($translations[$l_ItIsNotAllowedToVoteForYourOwnPicture])){$translations[$l_ItIsNotAllowedToVoteForYourOwnPicture]='';}
