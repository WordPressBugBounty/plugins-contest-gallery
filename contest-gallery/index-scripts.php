...
wp_enqueue_script( 'cg_js_v10_v10_js_min_cg_gallery_min', plugins_url( '/v10/v10-js-min/cg_gallery.min.js', __FILE__ ), array('jquery'), cg_get_version_for_scripts() );
...
wp_localize_script( 'cg_js_v10_v10_js_min_cg_gallery_min', 'post_cg_ecommerce_download_sale_order_wordpress_ajax_script_function_name', array(
