...
echo <<<HEREDOC
        <div id='cgSellSelectFilesForSale' class='cg_hide cg_sale_conf cg_download_sale $cgProFalse'>
                ...
                <p style="margin:10px auto;max-width: 600px;"><b class="cg_color_red">NOTE:</b> if this entry was sold the selected download files for selling will be downloadable for the customer on the order summary page. This entry will be connected to purchased order.<br>If you remove this entry after purchase then customers will  not be able to download the files on the order summary page. If you add further files to this entry the customers will be able to download the further files on order sammary page. <br>In short: this entry and all the downloads of this entry will be connected to the purchased orders of this entry.</p>
