...
= V25.0.2 =
* NEW: Long descriptions for entries, "Third title" in "Edit contact form", now available in normal version.
...
= V23.1.7 =
* FIXED: Removed not required code which might cause processing break in rare cases.
